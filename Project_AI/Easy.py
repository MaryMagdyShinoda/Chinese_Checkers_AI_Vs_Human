...
def Easy():
    ...
    thirdplayerP = [[12, 18], [12, 20], [12, 22], [12, 24], [11, 19], [11, 21], [11, 23], [10, 20], [10, 22],
                    [9, 21]]  # orange
    forthplayerP = [[16, 12], [15, 11], [15, 13], [14, 10], [14, 12], [14, 14], [13, 9], [13, 11], [13, 13],
                    [13, 15]]  # red
    ...
    def showPositions():
        for i in range(0, nb_col):
            for j in range(0, nb_ligne):
                ...
                pygame.draw.rect(screen, pygame.Color(0,0,0), rect, width=1)
    ...
    while game_on:
        if player_index1 == 2 or player_index2 == 3 or player_index3 == 4:
            ...
            # value is the depth
            value, best = minimax(pos, matrix, 1, True, [], [])
            pos = best[0]
            tar = best[1]
            move(pos, tar)
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if clicked_sprites:
                        ...
                        if matrix[clicked_token[0], clicked_token[1]] == player_index1 or matrix[
                            clicked_token[0], clicked_token[1]] == player_index2 or matrix[
                            clicked_token[0], clicked_token[1]] == player_index3:
